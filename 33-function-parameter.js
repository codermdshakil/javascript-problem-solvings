...
function sellinPrice(buyingPrice){
  const benifit = 250;
  const productSellPrice = buyingPrice + benifit;
  return productSellPrice;
};

// console.log(sellinPrice(30));



// 8. একটা ফাংশন লেখো, তারপর সেই ফাংশনে জন্ম সাল প্যারামিটার হিসেবে দেবে। তারপর সে বলে দেবে, কোন বছরে তোমার বয়স ১০০ বছর হবে।

function getYourOlderAge(dobYear){
  const olderAge = dobYear + 100;
  return olderAge;
}
